xh5_define("plugins.lightTKChart", ["utils.util"],
function() {
    "use strict";
    function t(t) {
        return null === t ? "Null": void 0 === t ? "Undefined": d.call(t).slice(8, -1)
    }
    function i(h, e, r) {
        if (!e) return h;
        h || (h = {});
        for (var a in e) e.hasOwnProperty(a) && ("Object" === t(e[a]) ? (!h[a] && (h[a] = {}), i(h[a], e[a], r)) : !r && a in h || (h[a] = e[a]));
        return h
    }
    function h(t, i, h) {
        t = "prototype" in t ? t.prototype: t,
        i = "prototype" in i ? i.prototype: i;
        for (var e in i) i.hasOwnProperty(e) && (h ? null != i[e] : null == t[e]) && (t[e] = i[e]);
        return t
    }
    function e(t, i) {
    ...
    function n(t) {
        return {
            day: {
                wfn: "xh5Fund",
                url: "//apo51.cn/fund/api/xh5Fund/nav/" + t + ".js"
            }
        }
    }
    function o(t, i, h, e) {
    ...
    function C(t, i, h, e) {
        var r = this,
        a = r.param[t][i];
        if (a) for (var s = a.length; s--;) if (a[s].name == h) return a.splice(s, 1),
        void(this[t] && this[t][i]([{
            name: h
        }], {
            toremove: !0,
            callback: function() {
    ...
    l = function() {
        ...
        return i.prototype = {
            ...
            off: function(t, i) {
                ...
                if (i) {
                    if (h[t]) {
                        for (var e = [], r = 0, a = h[t].length; a > r; r++) h[t][r].handler != i && e.push(h[t][r]);
                        h[t] = e
                    }
    ...
    f = a.prototype;
    return f.getChartType = function() {
    ...
    f._initTChart = function(t) {
        ...
        function(i) {
            e(i, s),
            h.inited && i.showView(h.currentView, {
                callback: function() {
    ...
    f._initNetWorthChart = function(t) {
        ...
        KKE.api("chart.h5k.dual", i({
            symbol: "dwjz_" + c,
            name: s(a.isFund) ? "\u5355\u4f4d\u51c0\u503c": "\u4e03\u65e5\u5e74\u5316\u6536\u76ca\u7387",
            datas: n(c),
            dual: {
                symbol: "ljjz_" + c,
                name: s(a.isFund) ? "\u7d2f\u8ba1\u51c0\u503c": "\u4e07\u4efd\u6536\u76ca",
                datas: n(c)
            },
            domid: a.domId,
            dom: a.dom
        ...
        function(i) {
            e(i, o),
            "netWorthChart" === r(a.initView) && h.trigger("chartInited", a.initView),
            h.netWorthChart = i,
    ...
    f._initRepayChart = function(t) {
        ...
        function(i) {
            e(i, s),
            "repayChart" === r(a.initView) && h.trigger("chartInited", a.initView),
            h.repayChart = i,
    ...
    f._initPredictChart = function(t) {
        ...
        function(i) {
            e(i, s),
            "predictChart" === r(a.initView) && h.trigger("chartInited", a.initView),
            h.predictChart = i,
    ...
    f.showView = function(t, i) {
        var h = this;
        if (t && t !== this.currentView) switch (this.currentView = t, this.getChartType()) {
        case "tChart":
            this.tChart ? (this.tChart.show(this.dom), this.tChart.showView(t, {
                callback: function() {
                    h.trigger("viewChange", t),
                    i && i()
                }
            ...
            break;
        case "kChart":
            this.kChart ? (this.kChart.show(this.dom), this.kChart.showView(t, {
                callback: function() {
                    h.trigger("viewChange", t),
                    i && i()
                }
            ...
            break;
        case "netWorthChart":
            this.netWorthChart ? this.netWorthChart.show(this.dom) : this.isPendingNetWorthChart || this._initNetWorthChart(i),
            this.hideExcept("netWorthChart");
            break;
        case "repayChart":
            this.repayChart ? this.repayChart.show(this.dom) : this.isPendingRepayChart || this._initRepayChart(i),
            this.hideExcept("repayChart");
            break;
        case "predictChart":
            this.predictChart ? this.predictChart.show(this.dom) : this.isPendingPredictChart || this._initPredictChart(i),
    ...
    f.show = function(t) {
        this.dom = t,
        this.getCurrentChart().show(t)
    },
    f.hide = function(t, i) {
        i ? this[i] && this[i].hide(t) : this.getCurrentChart().hide(t)
    },
    f.setReK = function(t) {
        this.param.kChart.setReK = t,
        this.kChart && this.kChart.setReK(t)
    },
    ...
    f.setCustom = function(t) {
        for (var i in t) t.hasOwnProperty(i) && (this.param.tChart.setCustom[i] = t[i], this.param.kChart.setCustom[i] = t[i]);
        this.tChart && this.tChart.setCustom(t),
        this.kChart && this.kChart.setCustom(t)
    },
    f.setDimension = function(t) {
        for (var i in t) t.hasOwnProperty(i) && (this.param.kChart.setDimension[i] = t[i]);
    ...
    f.showRangeSelector = function(t) {
        ...
        this.tChart ? this.tChart.showRangeSelector({
            display: t
        }) : this.param.tChart.showRangeSelector = {
            display: t
        },
        this.kChart ? this.kChart.showRangeSelector({
            display: t
    ...
    f.zoom = function(t, i) {
        i || (i = this.getChartType()),
        this[i] && this[i].zoom(t)
    },
    h(a, l),
    u
});;