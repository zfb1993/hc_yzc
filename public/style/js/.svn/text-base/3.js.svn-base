...
function() {
    ...
    function JsLoadHqM(e) {
        function t() {
            ...
            function() {
                function i() {
                    getScript("//" + window.location.host + "/api/real.php?list=sys_hqEtagMode",
                    function() {
            ...
            !
            function() {
                e.ssl ? (o = 0, t()) : getScript("//" + window.location.host + "/api/real.php?list=sys_clientip,sys_serverip",
                function() {
                    var e = window.hq_str_sys_clientip,
                    n = window.hq_str_sys_serverip;
                    getScript([a, "://", n, "/?list=sys_clientip"].join(""),
                    function() {
        ...
        e = merge({
            ssl: !1,
            host: window.location.host + "/api/real.php"
        },
        e || {}),
        _sslM.get() && (e.ssl = !0);
        var s, a = e.ssl ? "http": "http",
        r =  "//" + window.location.host + "/api/real.php?rn=$rand@type@@others@&list=".replace("$rand", String((new Date).getTime())),
        c =  "//" +  window.location.host + "/api/real.php?rn=$rand@type@@others@&list=",
        l = "",
        h = "hqEtagMode",
        u = "",
        f = {
    ...
    function AuthMgr(e, t) {
        function n(t) {
            r.ondebug("loading token from server...");
            var n = "//current.api.com.cn/auth/api/jsonp.php/$cb/AuthSign_Service.getSignCode?query=$type&ip=$ip&_=$rn&list=$list";
            e.cfg.isKick && (n += "&kick=1", e.cfg.isKick = !1),
            t && (n += "&s=1");
            var i = c || "",
            o = "KKE_auth_" + genRandomStr(),
            s = "var%20" + o + "=";
            getScript(n.replace("$ip", a).replace("$type", i).replace("$cb", s).replace("$rn", String(Math.random())).replace("$list", h),
            function() {
                var e = window[o];
                window[o] = null,
                N(e)
        ...
        function i(e) {
            r.ondebug("loading ipaddr...");
            var t = "sys_clientip",
            i = ["http", r.ssl ? "s": "", "://", l, "/?_=$rn&list=$symbol"].join("");
            getScript(i.replace("$rn", String((new Date).getTime())).replace("$symbol", t),
            function() {
                a = window["hq_str_" + t],
                n(e)
            })
        ...
        E = function(t) {
            ...
            k(),
            r.onerr(t),
            r.ondebug("exception occurred while authoring:" + t.result)
        },
        I = function(e) {
            if (f = e, r.ondebug("got new token"), !u) {
                var t = [f, "x"].join(p);
                if (hasLs) {
                    try {
        ...
        O = function(e) {
            ...
            if (e) {
                ...
                i = n[0],
                o = 1 * n[1];
                if (r.ondebug("checking local token time:" + o), !i || i.length < 9 || isNaN(o)) {
                    r.ondebug("unexpected local token")
                } else {
                    var s = (new Date).getTime() - o;
                    v > s ? t = {
                        token: i,
                        timeout: v - s
                    }: r.ondebug("local token is expired")
                }
            } else {
                r.ondebug("local token does not exist")
            }
            return t
        },
        N = function(e) {
            if (!e && ++S < 3) {
                return r.ondebug("error from php, retry..." + S),
                void i()
            }
            e = e || {};
            var t = e.msg_code || 0,
            n = e.result || null,
            o = e.timeout || 0 / 0;
            t == m && n && !isNaN(o) ? (I(n), C(1000 * o), r.onToken(t), S = 0, w = 0) : t == y && ++w < 2 ? (r.ondebug("php -7:nil cookie" + w), i()) : t == _ ? (r.ondebug("php -9:simultaneous"), i(!0)) : E(e)
        },
        T = function() {
            r.ondebug("checking local token...");
            var e;
            hasLs && (e = O(localStorage.getItem(g) || null)),
            e ? (r.ondebug("use local token"), f = e.token, C(e.timeout)) : i()
        };
        this.stopAuthRe = k,
        ...
        this.auth = function(t) {
            ...
            t || {}), isFunc(t.cb) ? o = t.cb: !isFunc(o) && (o = e.init), t.forceOnline ? t.noIp && a ? (r.ondebug("existing client ip:" + a), n()) : i() : T(), k())
        }
    }
    function log(e) {
    ...
    function getScript(e, t, n, i) {
        ...
        o.onload = o.onreadystatechange = function() {
            a || this.readyState && "loaded" !== this.readyState && "complete" !== this.readyState || (a = !0, t && setTimeout(t, 1), o.onload = o.onreadystatechange = null, setTimeout(function() {
                s.removeChild(o)
            },
            1))
        },
    ...
    var swfobject = function() {
        ...
        function n(e) {
            if (typeof x.addEventListener != N) {
                x.addEventListener("load", e, !1)
            } else {
                if (typeof j.addEventListener != N) {
                    j.addEventListener("load", e, !1)
                } else {
                    if (typeof x.attachEvent != N) {
                        m(x, "onload", e)
                    } else {
            ...
            if (n) {
                ...
                function() {
                    if (typeof n.GetVariable != N) {
                        ...
                        o && (o = o.split(" ")[1].split(","), H.pv = [parseInt(o[0], 10), parseInt(o[1], 10), parseInt(o[2], 10)])
                    } else {
                        if (10 > i) {
                            return i++,
            ...
            if (e > 0) {
                for (var t = 0; e > t; t++) {
                    ...
                    if (H.pv[0] > 0) {
                        var s = p(n);
                        if (s) {
                            if (!y($[t].swfVersion) || H.wk && H.wk < 312) {
                                if ($[t].expressInstall && r()) {
                                    var h = {};
                                    h.data = $[t].expressInstall,
                                    ...
                                    for (var u = {},
                                    f = s.getElementsByTagName("param"), d = f.length, g = 0; d > g; g++) {
                                ...
                                b(n, !0),
                                i && (o.success = !0, o.ref = a(n), i(o))
                            }
                        }
                    } else {
                        if (b(n, !0), i) {
                            var v = a(n);
                            v && typeof v.SetVariable != N && (o.success = !0, o.ref = v),
                            i(o)
                        }
                    }
                }
        ...
        function a(e) {
            ...
            if (n && "OBJECT" == n.nodeName) {
                if (typeof n.SetVariable != N) {
                    t = n
                } else {
                    var i = n.getElementsByTagName(T)[0];
                    i && (t = i)
                }
            }
            return t
        ...
        function r() {
            return ! G && y("6.0.65") && (H.win || H.mac) && !(H.wk && H.wk < 312)
        }
        function c(e, t, n, i) {
            G = !0,
            C = i || null,
            ...
            var o = p(n);
            if (o) {
                "OBJECT" == o.nodeName ? (w = h(o), k = null) : (w = o, k = n),
                e.id = M,
                ...
                a = "MMredirectURL=" + x.location.toString().replace(/&/g, "%26") + "&MMplayerType=" + s + "&MMdoctitle=" + j.title;
                if (typeof t.flashvars != N ? t.flashvars += "&" + a: t.flashvars = a, H.ie && H.win && 4 != o.readyState) {
                    var r = v("div");
                    n += "SWFObjectNew",
                    r.setAttribute("id", n),
        ...
        function u(e, t, n) {
            ...
            if (o) {
                if (typeof e.id == N && (e.id = n), H.ie && H.win) {
                    var s = "";
                    for (var a in e) {
        ...
        function _(e, t, n, i) {
            if (!H.ie || !H.mac) {
                ...
                if (o) {
                    ...
                    if (i && (I = null, O = null), !I || O != s) {
                        var a = v("style");
                        a.setAttribute("type", "text/css"),
                        a.setAttribute("media", s),
                        I = o.appendChild(a),
                        H.ie && H.win && typeof j.styleSheets != N && j.styleSheets.length > 0 && (I = j.styleSheets[j.styleSheets.length - 1]),
                        O = s
                    }
                    H.ie && H.win ? I && typeof I.addRule == T && I.addRule(e, t) : I && typeof j.createTextNode != N && I.appendChild(j.createTextNode(e + " {" + t + "}"))
                }
            }
        }
        function b(e, t) {
            if (V) {
                ...
                P && p(e) ? p(e).style.visibility = n: _("#" + e, "visibility:" + n)
            }
        }
        function S(e) {
            var t = /[\\\"<>\.;]/,
        ...
        V = !0,
        H = function() {
            var e = typeof j.getElementById != N && typeof j.getElementsByTagName != N && typeof j.createElement != N,
            ...
            r = [0, 0, 0],
            c = null;
            if (typeof D.plugins != N && typeof D.plugins[W] == T) {
                c = D.plugins[W].description,
                !c || typeof D.mimeTypes != N && D.mimeTypes[L] && !D.mimeTypes[L].enabledPlugin || (R = !0, a = !1, c = c.replace(/^.*\s+(\S+\s+\S+$)/, "$1"), r[0] = parseInt(c.replace(/^(.*)\..*$/, "$1"), 10), r[1] = parseInt(c.replace(/^.*\.(.*)\s.*$/, "$1"), 10), r[2] = /[a-zA-Z]/.test(c) ? parseInt(c.replace(/^.*[a-zA-Z]+(.*)$/, "$1"), 10) : 0)
            } else {
                if (typeof x.ActiveXObject != N) {
                    try {
                        var l = new ActiveXObject(A);
                        l && (c = l.GetVariable("$version"), c && (a = !0, c = c.split(" ")[1].split(","), r = [parseInt(c[0], 10), parseInt(c[1], 10), parseInt(c[2], 10)]))
                    } catch(h) {}
                }
            }
            return {
        ...
        function() {
            H.w3 && ((typeof j.readyState != N && "complete" == j.readyState || typeof j.readyState == N && (j.getElementsByTagName("body")[0] || j.body)) && e(), P || (typeof j.addEventListener != N && j.addEventListener("DOMContentLoaded", e, !1), H.ie && H.win && (j.attachEvent(F,
            function() {
                "complete" == j.readyState && (j.detachEvent(F, arguments.callee), e())
            }), x == top && !
            function() {
                if (!P) {
                    try {
            ...
            function() {
                return P ? void 0 : /loaded|complete/.test(j.readyState) ? void e() : void setTimeout(arguments.callee, 0)
            } (), n(e)))
        } (),
        function() {
            H.ie && H.win && window.attachEvent("onunload",
            function() {
                for (var e = U.length,
                t = 0; e > t; t++) {
        ...
        return {
            ...
            embedSWF: function(e, n, i, o, s, a, l, h, f, d) {
                ...
                H.w3 && !(H.wk && H.wk < 312) && e && n && i && o && s ? (b(n, !1), t(function() {
                    i += "",
                    o += "";
                    var t = {};
                    if (f && typeof f === T) {
                    ...
                    if (l && typeof l === T) {
                        for (var _ in l) {
                            typeof v.flashvars != N ? v.flashvars += "&" + _ + "=" + l[_] : v.flashvars = _ + "=" + l[_]
                        }
                    }
                    if (y(s)) {
                        var S = u(t, v, n);
            ...
            expressInstallCallback: function() {
                if (G) {
                    var e = p(M);
                    e && w && (e.parentNode.replaceChild(w, e), k && (b(k, !0), H.ie && H.win && (w.style.display = "block")), C && C(E)),
                    G = !1
                }
            }
        }
    ...
    Cookie.set = function(e, t, n) {
        ...
        if (n.expires && (1 * n.expires || n.expires.toUTCString)) {
            var o;
            1 * n.expires ? (o = new Date, o.setTime(o.getTime() + 1000 * n.expires)) : o = n.expires,
    ...
    function() {
        var e = !1;
        0 == location.protocol.indexOf("http:") && (e = !0),
        this.SSL_SWF_URL = "//current.api.com.cn/theone/SwfWebSocket.swf",
        this.get = function() {
            return e
        }
    },
    ...
    __phpUA = void 0;
    WEB_SOCKET_SWF_LOCATION = window.WEB_SOCKET_SWF_LOCATION || "//i2.apiimg.cn/woocall/swf/api_financews_20150514c.swf",
    checkNative() || !
    function() {
        var e;
        ...
        swfobject.getFlashPlayerVersion().major < 10 ? (e.error("Flash Player >= 10.0.0 is required."), window.WebSocket = window.WebSocket || {},
        window.WebSocket.canUse = !1, void(window.WebSocket.isNotNative = !0)) : ("file:" == location.protocol && e.error("WARNING: web-socket-js doesn't work in file:///... URL unless you set Flash Security Settings properly. Open the page via Web server i.e. //..."), window.WebSocket = function(e, t, n, i, o) {
            var s = this;
        ...
        window.WebSocket.isNotNative = !0, WebSocket.prototype.send = function(e) {
        ...
        WebSocket.canUse = !0, WebSocket.__initialize = function() {
            if (!WebSocket.__initialized) {
                ...
                _sslM.get() && 0 != o.indexOf("http:") && (o = _sslM.SSL_SWF_URL, WEB_SOCKET_SWF_LOCATION = o),
                ...
                null,
                function(t) {
                    t.success || (WebSocket.canUse = !1, e.error("[WebSocket] swfobject.embedSWF failed"))
                })
            }
        },
        WebSocket.flashOK = !1, WebSocket.__onFlashInitialized = function() {
            setTimeout(function() {
                WebSocket.flashOK = !0,
    ...
    if (!IO.WebPush4) {
        if (IO.WebPush4 = function(e, t, n, i) {
            if (e = e.match(/(\w*:\/\/)?([^\/]+)(\/+.*)?/i)[2], this.id = "ws_" + getHashCode(e + t), this.host = e || "window.location.host/api/real.php", this.list = (t + "").split(","), this.onmessage = n, i && isNaN(i.retryinterval)) {
            ...
            i || {}),
            this.cfg.interval <= 0 && (this.cfg.interval = 1, log("set refresh interval to 1s")),
            this.cfg.retryinterval < 0 && (this.cfg.retryinterval = 0, log("set retry interval to 0")),
            _sslM.get() && (this.cfg.ssl = !0),
            this.cfg.ssl || "newspush.api51.cn" === this.host && (this.cfg.ssl = !0),
            this.isAuth = !1,
            this.authFailCount = 0,
            this.authMgr = void 0,
            this.cfg.authtype && "" != this.cfg.authtype ? this.authInit() : this.init()
        },
        merge(IO.WebPush4.prototype, {
            ...
            resymbols: function(e) {
                if (e && !(e.length < 1) && this.connection) {
                    if (1 == this.connection.readyState) {
                        this.list = (e + "").split(",");
                        var t = "=" + e;
                        this.cfg.ondebug("new keys:" + this.list),
                ...
                if (this.connection) {
                    ...
                    if (t && !(t.length < 1)) {
                        ...
                        if (1 == this.connection.readyState) {
                            var i = e.authtype;
                            this.list = (t + "").split(","),
                            this.cfg.ondebug("keys change to:" + this.list + ", and auth type: " + i),
                            i ? (this.cfg.authtype = i, this.isAuth = !0, this.authMgr || (this.authMgr = new AuthMgr(this)), this.authMgr.setList(t), this.authMgr.auth({
                                forceOnline: !0,
                                cb: function() {
                                    var e = [n.RESET_SIGN, t, "\n", n.RENEW_SIGN, n.authMgr.getToken()].join("");
                                    n.connection.send(e)
                                },
                                noIp: !1
                            })) : (this.cfg.authtype = void 0, this.isAuth = !1, clearInterval(this.authReId), this.connection.send([this.RESET_SIGN, t].join("")))
                        } else {
                            this.cfg.ondebug("websocket connection is not available")
                        }
                    }
            ...
            arequest: function(e) {
                if (this.connection) {
                    ...
                    if (t && !(t.length < 1)) {
                        ...
                        if (1 == this.connection.readyState) {
                            var i = e.authtype;
                            if (this.cfg.ondebug(["query keys for once:", t, "and auth type:", i].join(" ")), i) {
                                var o = new AuthMgr(this, {
                                    istemp: !0,
                                    list: t,
                                    authtype: i
                                });
                                o.auth({
                                    forceOnline: !0,
                                    cb: function() {
                                        var e = [n.ONCE_SIGN, t, "\n", n.ONCE_AUTH_SIGN, o.getToken()].join("");
                                        n.connection.send(e)
                                    },
                                    noIp: !1
                                })
                            } else {
                                this.connection.send([this.ONCE_SIGN, t].join(""))
                            }
                        } else {
                            this.cfg.ondebug("websocket connection is not available")
                        }
            ...
            renewalWithNewToken: function(e) {
                ...
                if (this.cfg.ondebug("try to renew the connection with " + (e ? "exiting": "new") + " token"), 1 == this.connection.readyState) {
                    if (this.authMgr) {
                        var t = this.RENEW_SIGN + this.authMgr.getToken();
                        this.connection.send(t)
                    } else {
            ...
            setReTimeout: function(e) {
                if (this.cfg.ondebug("receiving timeout(ms):" + e), !isNaN(e) && (clearInterval(this.authReId), 0 != e)) {
                    e -= 1000 * Math.floor(5 * Math.random() + 2),
                    this.cfg.ondebug("set timeout(ms):" + e);
                    var t = this;
                    this.authReId = setInterval(function() {
                        t.cfg.ondebug("timeup"),
                        t.authMgr && t.authMgr.auth({
            ...
            listen: function(data) {
                function _makeKV($0, $1, $2) {
                    ...
                    d && (_self.lastData[$1] = _self.lastData[$1] || null, _self.lastData[$1] === d ? _self.cfg.allowrepeat && (_data[$1] = d, _hasData = !0) : (_data[$1] = _self.lastData[$1] = d, _hasData = !0))
                }
                if (data) {
                    for (var _messages = data.match(/^[\s\S]+?$/gm), _data = {},
                    _format = this.cfg.format, _nxKeyValue = this.cfg.nxkeyvalue, _hasData = !1, _self = this, msg, i = 0, l = _messages.length; l > i; i++) {
                        if (msg = _messages[i], /^sys_/.test(msg)) {
                            if (_nxKeyValue && 0 == msg.indexOf("sys_nxkey=")) {
                                for (var nxArr = msg.split("="), keyArr = nxArr[1].split(","), j = keyArr.length; j--;) {
                                    _makeKV(msg, keyArr[j], _nxKeyValue)
                                }
                            }
                        } else {
                            _messages[i].replace(/([^=]*)=([\s\S]*)/, _makeKV)
                        }
                    }
                    _hasData && (this.onmessage(_data), this.authFailCount = 0)
                }
            },
            retry: function() {
                this.retryClose(),
                this.cfg.ondebug("retrying..."),
                this.isAuth ? this.authMgr.auth({
            ...
            checkOnSysErr: function(e, t) {
                if (e && e.indexOf("sys_auth=") >= 0) {
                    if (t && (window[t + "sys_auth"] = null), e.indexOf("FAILED") > 0) {
                        this.cfg.ondebug("receive FAILED from server");
                        var n = this.isAuth ? ++this.authFailCount > 2 : ++this.authFailCount > 9;
                        return n ? (this.cfg.ondebug("too many retries for FAILED, stop and disconnect"), this.close(), this.authFailCount = 0, this.cfg.onerr({
                            msg_code: -3,
                    ...
                    if (e.indexOf("INVALID") > 0) {
                        ...
                        this.isAuth ? ++this.authFailCount > 5 ? (this.cfg.ondebug("too many retries for FAILED, renew the token"), this.retry()) : this.renewalWithNewToken(!0) : this.cfg.ondebug("ignore INVALID for non auth mode"),
                        !0
                    }
            ...
            tryNative: function() {
                return this.cfg.ishttp ? !1 : (this.cfg.ondebug("try Native WebSocket service"), checkNative() ? (this.nativeOK(), this.tryNative = function() {
                    return ! 0
                },
            ...
            subScribeNative: function() {
                ...
                var e = this.cfg.ssl ? "http": "ws",
                t = [e, "://", this.host, "/api/real.php"].join("");
				try
  {
  //在这里运行代码

                if (this.cfg.ispmd && (t += ".pmd"), t += "?", this.isAuth && (t += "token=" + this.authMgr.getToken() + "&"), t += "list=" + this.list.join(","), this.connection = new this.socket(t), !this.socket.isNotNative && !this.connection.binaryType) {
                ...
                this.connection.onerror = function() {
                    n.mode == n.MODE_FLASH && (n.cfg.ondebug("flash error, close and retry..."), n.onClose())
                }}
catch(err)
  {
  //在这里处理错误
            ...
            parseData: function(e) {
                this.checkOnSysErr(e) || (this.cfg.local ? this.localConn && this.localConn.sendc(this.cfg.nxkeyvalue ? e: e.replace(/^sys_[\s\S]*?$(\r|\n)/gm, "")) : this.listen(this.cfg.nxkeyvalue ? e: e.replace(/^sys_[\s\S]*?$(\r|\n)/gm, "")))
            },
            ...
            retryCloseNative: function() {
                ...
                this.isAuth && this.authMgr.stopAuthRe(),
                this.connection && (clearInterval(this.connection.refresher), this.connection.refresher = this.connection.onmessage = this.connection.onclose = null, this.connection.close(), this.connection = null)
            },
            closeNative: function() {
                ...
                this.connection && (clearInterval(this.connection.refresher), this.connection.onclose = function() {},
            ...
            onCloseNative: function() {
                ...
                this.closeTimes > this.maxRetryTimes ? (this.cfg.ondebug("too many retries, switch to JS mode"), void this.tryJS(!0)) : void setTimeout(fnBind(this.subscribe, this), 1000 * this.cfg.retryinterval)
            },
            __gotPhpUa: function() {
                if (!__phpUA) {
            ...
            flashTryLimits: 5,
            tryFlash: function() {
                return this.cfg.ishttp ? !1 : this.flashTryLimits--<0 ? (this.cfg.ishttp = !0, !1) : (this.cfg.ondebug("try Flash mode, or waiting for Flash component responses"), WebSocket.flashOK ? (this.isAuth && this.setStaticFlashUa(), this.flashOK(), this.tryFlash = function() {
                    return ! 0
                },
            ...
            subScribeJS: function() {
                ...
                t = function() {
                    ...
                    e.isAuth && (t.others = "&token=" + e.authMgr.getToken()),
                    e.httpLoadHq(e.list, fBind(e.receive, e), t)
                };
                t(),
                this.connection = setInterval(t, 1000 * this.cfg.interval)
            },
            receiveJS: function() {
                var e = {},
                ...
                if (!this.checkOnSysErr(window[t + "sys_auth"], t)) {
                    for (var n, i = 0,
                    o = this.list.length; o > i; i++) {
                        this.lastData[this.list[i]] !== window[t + this.list[i]] && (this.lastData[this.list[i]] = e[this.list[i]] = window[t + this.list[i]], n = !0)
                    }
                    n && (this.onmessage(e), this.authFailCount = 0)
                }
            },
            closeJS: function() {
                this.subscribe = function() {},
            ...
            var _iframeID = "IO_WEBPUSH4_LOCALCONN_IFRAME",
            _iframe, _pWin, proxy = void 0;
            IO.LocalConn4 = function(e) {
                var t = e.ssl ? "//current.api.com.cn/theone/IO.WebPush4.localConn.html": "//woocall.api.com.cn/lib/iframe/IO.WebPush4.localConn.htm";
                if (_iframe || ((_iframe = document.getElementById(_iframeID)) || (_iframe = document.createElement("iframe"), _iframe.id = _iframeID, _iframe.style.display = "none", _iframe.src = t, document.body.insertBefore(_iframe, document.body.firstChild)), _pWin = _iframe.contentWindow, addEvent(window, "message",
                function(e) {
                ...
                proxy.listen(function(e) {
                    if (e.data && isFunc(e.data.indexOf) && -1 != e.data.indexOf(n.id + ":")) {
                        var t, i;
                        switch (e.data.replace(/([^:]+):([\s\S]*)/,
                        function() {
                            t = arguments[1],
                            i = arguments[2]
                        }), t) {
                        case "IO_LOCALCONN_ONCHANGE_" + n.id: n.onchange(i);
                            break;
                        case "IO_LOCALCONN_ONMESSAGE_" + n.id: n.onmessage(i)
                        }
                    }
                }),
